...
if defined MAVEN_JAVA_EXE goto init

echo. >&2
echo Error: JAVA_HOME not found in your environment. >&2
echo Please set the JAVA_HOME variable in your environment or make sure java.exe is on PATH. >&2
echo. >&2
goto error
...
if not defined MAVEN_JAVA_EXE set MAVEN_JAVA_EXE=%JAVA_HOME%\bin\java.exe
